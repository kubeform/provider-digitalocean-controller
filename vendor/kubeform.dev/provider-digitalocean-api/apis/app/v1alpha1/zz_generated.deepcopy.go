...
func (in *AppSpecSpecService) DeepCopyInto(out *AppSpecSpecService) {
	*out = *in
	...
	if in.Cors != nil {
		...
		*out = new(AppSpecSpecServiceCors)
		(*in).DeepCopyInto(*out)
	}
	if in.DockerfilePath != nil {
		in, out := &in.DockerfilePath, &out.DockerfilePath
...
func (in *AppSpecSpecServiceCors) DeepCopyInto(out *AppSpecSpecServiceCors) {
	*out = *in
	...
	if in.AllowOrigins != nil {
		...
		*out = new(AppSpecSpecServiceCorsAllowOrigins)
		(*in).DeepCopyInto(*out)
	}
...
func (in *AppSpecSpecStaticSite) DeepCopyInto(out *AppSpecSpecStaticSite) {
	*out = *in
	...
	if in.Cors != nil {
		in, out := &in.Cors, &out.Cors
		*out = new(AppSpecSpecStaticSiteCors)
		(*in).DeepCopyInto(*out)
	}
	if in.DockerfilePath != nil {
		in, out := &in.DockerfilePath, &out.DockerfilePath
...
func (in *AppSpecSpecStaticSiteCors) DeepCopyInto(out *AppSpecSpecStaticSiteCors) {
	*out = *in
	...
	if in.AllowOrigins != nil {
		in, out := &in.AllowOrigins, &out.AllowOrigins
		*out = new(AppSpecSpecStaticSiteCorsAllowOrigins)
		(*in).DeepCopyInto(*out)
	}
	if in.ExposeHeaders != nil {
		in, out := &in.ExposeHeaders, &out.ExposeHeaders
