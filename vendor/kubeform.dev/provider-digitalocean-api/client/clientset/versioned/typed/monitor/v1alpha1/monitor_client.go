...
// MonitorV1alpha1Client is used to interact with features provided by the monitor.digitalocean.kubeform.com group.
type MonitorV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MonitorV1alpha1Client) Alerts(namespace string) AlertInterface {
