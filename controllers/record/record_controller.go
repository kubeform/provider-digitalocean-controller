...
// +kubebuilder:rbac:groups=record.digitalocean.kubeform.com,resources=records,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=record.digitalocean.kubeform.com,resources=records/status,verbs=get;update;patch
...
func (r *RecordReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &recordv1alpha1.Record{}); err != nil {
			klog.Error(err, "unable to set up auditor", recordv1alpha1.Record{}.APIVersion, recordv1alpha1.Record{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&recordv1alpha1.Record{}).
