...
// +kubebuilder:rbac:groups=database.digitalocean.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.digitalocean.kubeform.com,resources=users/status,verbs=get;update;patch
