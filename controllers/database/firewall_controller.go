...
// +kubebuilder:rbac:groups=database.digitalocean.kubeform.com,resources=firewalls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.digitalocean.kubeform.com,resources=firewalls/status,verbs=get;update;patch
...
func (r *FirewallReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &databasev1alpha1.Firewall{}); err != nil {
			klog.Error(err, "unable to set up auditor", databasev1alpha1.Firewall{}.APIVersion, databasev1alpha1.Firewall{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&databasev1alpha1.Firewall{}).
