...
// +kubebuilder:rbac:groups=cdn.digitalocean.kubeform.com,resources=cdns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cdn.digitalocean.kubeform.com,resources=cdns/status,verbs=get;update;patch
...
func (r *CdnReconciler) SetupWithManager(mgr ctrl.Manager) error {
