...
// +kubebuilder:rbac:groups=floatingip.digitalocean.kubeform.com,resources=floatingips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=floatingip.digitalocean.kubeform.com,resources=floatingips/status,verbs=get;update;patch
...
func (r *FloatingIPReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &floatingipv1alpha1.FloatingIP{}); err != nil {
			klog.Error(err, "unable to set up auditor", floatingipv1alpha1.FloatingIP{}.APIVersion, floatingipv1alpha1.FloatingIP{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&floatingipv1alpha1.FloatingIP{}).
