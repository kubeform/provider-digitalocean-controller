...
// +kubebuilder:rbac:groups=floatingip.digitalocean.kubeform.com,resources=assignments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=floatingip.digitalocean.kubeform.com,resources=assignments/status,verbs=get;update;patch
...
func (r *AssignmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &floatingipv1alpha1.Assignment{}); err != nil {
			klog.Error(err, "unable to set up auditor", floatingipv1alpha1.Assignment{}.APIVersion, floatingipv1alpha1.Assignment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&floatingipv1alpha1.Assignment{}).
