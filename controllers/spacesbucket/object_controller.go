...
// +kubebuilder:rbac:groups=spacesbucket.digitalocean.kubeform.com,resources=objects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=spacesbucket.digitalocean.kubeform.com,resources=objects/status,verbs=get;update;patch
...
func (r *ObjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &spacesbucketv1alpha1.Object{}); err != nil {
			klog.Error(err, "unable to set up auditor", spacesbucketv1alpha1.Object{}.APIVersion, spacesbucketv1alpha1.Object{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&spacesbucketv1alpha1.Object{}).
