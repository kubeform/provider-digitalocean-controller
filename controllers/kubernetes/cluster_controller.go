...
// +kubebuilder:rbac:groups=kubernetes.digitalocean.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubernetes.digitalocean.kubeform.com,resources=clusters/status,verbs=get;update;patch
