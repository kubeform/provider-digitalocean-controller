...
// +kubebuilder:rbac:groups=app.digitalocean.kubeform.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=app.digitalocean.kubeform.com,resources=apps/status,verbs=get;update;patch
