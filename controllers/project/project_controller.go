...
// +kubebuilder:rbac:groups=project.digitalocean.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.digitalocean.kubeform.com,resources=projects/status,verbs=get;update;patch
