...
// ResourcesReconciler reconciles a Resources object
...
// +kubebuilder:rbac:groups=project.digitalocean.kubeform.com,resources=resources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.digitalocean.kubeform.com,resources=resources/status,verbs=get;update;patch

func (r *ResourcesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("resources", req.NamespacedName)
...
func (r *ResourcesReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &projectv1alpha1.Resources{}); err != nil {
			klog.Error(err, "unable to set up auditor", projectv1alpha1.Resources{}.APIVersion, projectv1alpha1.Resources{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&projectv1alpha1.Resources{}).
