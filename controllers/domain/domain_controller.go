...
// +kubebuilder:rbac:groups=domain.digitalocean.kubeform.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=domain.digitalocean.kubeform.com,resources=domains/status,verbs=get;update;patch
